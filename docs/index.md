  ...
  <div class="container">
    <div class="hero">
      <h1 class="hero-heading">
        <span class="heading-gradient">noˑcodeˑroom</span>
      </h1>
      <p class="hero-subheading">
        No code REST API server based on zencode natural language smart contracts
      </p>
      <div class="hero-actions">
        <a href="/ncr/quickstart/" class="hero-action primary">
          Quickstart
        </a>
        <a href="/ncr/info/" class="hero-action secondary">
          More info
        </a>
      </div>
    </div>
  ...
  <div class="container">
    <div style="display: flex; justify-content: center">
      <div class="start-link">
        <a href="/ncr/quickstart/">Start writing ncr</a>
      </div>
    </div>
